...
`AlertConfig` holds the whole per-city configuration: `city`, `city_slug`, `coordinates`, `timezone`, `region`, `thresholds`, `checklist`, `active_channel`, `forecast_hours`, `dedup_lookback_hours`.
